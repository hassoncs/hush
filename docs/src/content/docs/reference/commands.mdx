...
<Aside type="tip">
When a variable is missing, check the 🚫 EXCLUDED section to see which pattern filtered it out. This immediately tells you whether to adjust your `include`/`exclude` patterns.
</Aside>
