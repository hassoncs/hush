...
|----------|----------|-------------|
| **Primary (AI-Safe)** | `run`, `materialize`, `set`, `edit`, `inspect`, `has` | Safe command surfaces that avoid printing secret values |
...
| **Debugging** | `resolve`, `trace`, `diff`, `export-example` | Debug safe output, provenance, and example generation |
