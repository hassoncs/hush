...
<Aside type="tip">
**For AI agents:** Use **push** when you see patterns like "route all NEXT_PUBLIC_* vars" or "exclude client vars from API". Use **pull** when you need to rename, transform, or add defaults to variables.
</Aside>
