...
hero:
  ...
  image:
    html: '<img src="../../assets/images/hero.png" alt="Bioluminescent jellyfish representing AI-native secrets management" style="width: 100%; height: auto; border-radius: 8px; display: block; margin: 0 auto;">'
  actions:
    - text: Get Started
